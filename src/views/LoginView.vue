    ...
    <div class="login-page">
        <div class="login-page__form-container">
            <form @submit.prevent="onSubmit" class="login-page__form">
                ...
                <div class="error" v-if="!$v.email.required">Campo brigatório</div>
                <div class="error" v-if="!$v.email.email">Insira um e-mail válido</div>
                <base-input v-model="password" label="Digite a sua password" type="password" place-holder="Digite aqui a sua password" />
                <div class="error" v-if="!$v.password.required">Campo obrigatório</div>
